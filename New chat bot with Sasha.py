...
vk=vk_api.VkApi(login='логин', password='пароль', token=token)  # scope - права доступа(не знаю точно, что это)
...
print(  # Получаем информацию о чате.
		 vk.method('messages.getConversations')  # messages.getConversations
		# vk.method('users.get')
		)
